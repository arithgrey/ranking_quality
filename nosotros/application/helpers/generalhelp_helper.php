...
function evalua_titulo_menu_principal($info_empresa ='' ,  $email ='' ){    
    $menu =  "Bienvenido"; 
...
/**/
function evalua_menu_principal($in_session){
...
function header_modal_langing($id){
...
if(!function_exists('invierte_date_time')){
  ...
  function create_url_preview($tipo , $val_extra='' ){
    ...
    switch ($tipo) {
      ...
      /*Página principal */
      case 7:
        return base_url('application/img/11.jpg');
        break; 
      ...
      /*Recorrido */    
      case 10:
        return base_url('application/img/49.png');
        break;

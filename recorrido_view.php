...
<body id="page-top" class="index">
    ...
    <section id='contacto'>
        <div class='container'>
            ...
            <div class="row">
                <center>
                    <?=btn_call_to_action(1 , "page-scroll btn_detalle btn btn-xl" , "btn_contacto" , "" , "Contáctame",  url_developer()."/#contacto" )?>
                </center>
            </div>    
        </div>

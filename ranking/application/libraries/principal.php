<?php if (!defined('BASEPATH')) exit('No permitir el acceso directo al script');
	...
	class principal extends CI_Model implements  iRegistro{	 			
		...
		function show_data_page($data , $center_page ){           
	            ...
	            $this->load->view("../../../view_tema_r/header_template", $data);
	            $this->load->view($center_page , $data);            
	            $this->load->view("../../../view_tema_r/footer_template", $data);
    	...
    	function createsession($id_usuario, $nombre , $email){
	        ...
	        $nombre_empresa =  $this->enidmodel->get_nombre_empresa($id_empresa);	        

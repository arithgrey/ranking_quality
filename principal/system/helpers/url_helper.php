...
/**/
if ( ! function_exists('url_img_servicio')){
	
	function url_img_servicio($id_servicio){

		return "../img/index.php/enid/imagen_categoria/".$id_servicio."/";
	}
}

/**/
if ( ! function_exists('url_modo_fb')){
	
	function url_modo_fb($id_empresa ){
		//return "http://enidservice.com/ranking_quality/ranking/index.php/opiniones/emp/".$id_empresa."/";    
		return "../ranking/index.php/opiniones/emp/".$id_empresa."/";
	}
}
/**/
...
if ( ! function_exists('url_presentacion'))
{
	function url_presentacion(){
		return base_url('index.php/startsession/presentacion');
	}	
}
/**/
...
if ( ! function_exists('url_info_cuenta')){
	function url_info_cuenta(){
		return  'http://enidservice.com/home/administracion_cuenta'; 
	}	
}
/**/
if ( ! function_exists('url_busqueda_eventos')){
	function url_busqueda_eventos(){
		return  'http://enidservice.com/home/busqueda/'; 
	}	
}
/**/
/**/
...
if ( ! function_exists('url_inicio_eventos'))
{
	...
	{
		return base_url('index.php/inicio/eventos');    
	}
}
/**/

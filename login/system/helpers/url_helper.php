...
if ( ! function_exists('url_recuperacion_password')){
	...
	function url_recuperacion_password(){
		...
		return "../mensajeria/index.php/api/mailrest/recupera_password/format/json/";    
	}
}

/**/
if ( ! function_exists('url_prospectos')){
	
	function url_prospectos(){
		return "../nosotros/#tarifas";    
	}
}
/**/
if ( ! function_exists('url_principal')){
	
	function url_principal(){
		return "../nosotros/";    
	}
}
...
if ( ! function_exists('url_presentacion'))
{
	function url_presentacion(){
		return '../home/index.php/startsession/presentacion';
	}	
}
/**/
...
if ( ! function_exists('url_log_out'))
{
	function url_log_out(){
		return base_url('index.php/startsession/logout');
	}	
}
/**/
